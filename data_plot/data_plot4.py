...
plt.title('Формула 1 - 2022 Сезон\nКоличество побед у гонщиков', fontsize=19, fontweight='bold', color='#bbbbbb')
plt.xlabel('КОЛИЧЕСТВО ПОБЕД', fontsize=14, fontweight='bold', color='#bbbbbb')
...
plt.savefig('data_plot/plot_4.png')