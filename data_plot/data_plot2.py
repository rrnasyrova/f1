...
plt.title('Формула 1 - 2022 Сезон\nБаллы, полученные со спринта', fontsize=19, fontweight='bold', color='#bbbbbb')
plt.xlabel('БАЛЛЫ', fontsize=14, fontweight='bold', color='#bbbbbb')
...
plt.savefig('data_plot/plot_2.png')